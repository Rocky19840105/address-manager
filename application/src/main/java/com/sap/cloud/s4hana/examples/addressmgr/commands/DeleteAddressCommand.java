...
public class DeleteAddressCommand {
    ...
    public Integer execute() throws Exception {
        ...
        BusinessPartnerAddress businessPartnerAddress = BusinessPartnerAddress.builder().businessPartner(this.businessPartnerId)
                .addressID(this.addressId).build();

        ODataDeleteResult oDataDeleteResult = this.service.deleteBusinessPartnerAddress(businessPartnerAddress).execute();
